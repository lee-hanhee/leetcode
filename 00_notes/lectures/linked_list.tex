            ...
            \midrule
                ...
                \multicolumn{2}{p{\linewidth}}{
                    \begin{itemize}
                        ...
                        \begin{itemize}
                            \item \texttt{fast}: Ensures the fast pointer is not \texttt{None}, so that accessing \texttt{fast.next} is safe.
                            \item \texttt{fast.next}: Ensures that \texttt{fast.next.next} is valid, allowing the fast pointer to move two steps ahead without error.
                        \end{itemize}                        
                    \end{itemize}
                } \\
                \midrule

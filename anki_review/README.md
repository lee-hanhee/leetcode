...
---- | ---- | ---- | ----
<sub>[Binary Search](https://leetcode.com/problems/binary-search)</sub> | <sub>-</sub> | <sub>⚠️ <span style="color:red">-</span></sub> | <sub>[Python](../02_binary_search/exercises/00_binary_search.py)</sub>
